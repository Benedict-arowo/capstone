"""
Django settings for keymdall project.
...
SECRET_KEY = 'django-insecure-(zu6_1e(g@+*2qq0(hxt(kn881(dmz+ng0c&kz@t90xh#^p_ba'
...
WSGI_APPLICATION = 'keymdall.wsgi.application'
